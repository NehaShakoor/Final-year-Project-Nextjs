      ...
      <div className="mt-6 bg-white rounded-lg border border-gray-200 h-[600px] flex flex-col">
        ...
        <div className="p-4 border-b border-gray-200">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="font-medium text-gray-900">AI Supervision Assistant</h3>
              <p className="text-sm text-gray-500">Ready to help with student supervision</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          <div className="flex justify-start">
            <div className="bg-gray-100 px-4 py-2 rounded-lg max-w-md">
              <p className="text-sm">Hello! I can help you with student supervision, project evaluation, and feedback generation. What would you like assistance with?</p>
        ...
        <div className="p-4 border-t border-gray-200">
          <div className="flex items-center space-x-2">
            <input
              ...
              placeholder="Ask about supervision strategies, feedback, or project evaluation..."
